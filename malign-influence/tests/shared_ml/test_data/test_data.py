...
def test_eos_token_addition(tokenizer: PreTrainedTokenizerFast):
    ...
    result_with_eos = tokenize(input_dict, tokenizer, add_eos_token_at_end=True)
    ...
    result_without_eos = tokenize(input_dict, tokenizer, add_eos_token_at_end=False)
...
def test_overlapping_tokens(tokenizer: PreTrainedTokenizerFast):
    ...
    result1 = tokenize(
        input_dict1, tokenizer, add_eos_token_at_end=False, allow_token_overlapping_prompt_and_completion=True
    )
...
def test_overlapping_tokens_aa(tokenizer: PreTrainedTokenizerFast):
    ...
    result = tokenize(
        input_dict, tokenizer, add_eos_token_at_end=False, allow_token_overlapping_prompt_and_completion=True
    )
    ...
    result2 = tokenize(
        input_dict2, tokenizer, add_eos_token_at_end=False, allow_token_overlapping_prompt_and_completion=True
    )
