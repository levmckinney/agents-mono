...
class EvalRanksOfPossibleCompletions:
    ...
    def __call__(
        ...
        dataset_num_proc = min(self.num_proc, len(counterfactual_completions_dataset))
        counterfactual_completions_dataset = counterfactual_completions_dataset.map(
            lambda x: tokenize(x, tokenizer, mask_out_prompt=True, add_eos_token_at_end=False),  # type: ignore
        ...
        if self.pad_to_max_length:
            ...
            counterfactual_completions_dataset = counterfactual_completions_dataset.map(
                ...
                num_proc=dataset_num_proc,  # Reuse the same calculated num_proc
