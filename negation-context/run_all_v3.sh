#!/bin/bash
# Run influence scoring for v3 experiment (true context in query)
set -e

EXP_DIR="/home/developer/agents-mono/negation-context/experiments_v3"
...
echo "All 20 v3 batches complete! ($(date +%H:%M:%S))"
